...
<head>  
  ...
  //export Csv
  function exportCsv(){
  	window.location.href="csv.action";
  }
...
<!--						<td>to </td><td> <input id="endAnt" name="endAnt" class="easyui-number" style="width:100px;"/></td>-->
						...
						<td>  <a class="easyui-linkbutton" plain="true" iconCls="icon-cancel" onclick="resetQueryParams();">Clear</a> </td>
                 ...
                 <script>  
			        ...
			        $(function(){  
			            $('#tt2').datagrid({  
			                ...
			                striped: true,  
			                fit: true,
			                url:'merchantClearing.action',  
			                sortOrder: 'desc',  
			                singleSelect:true,
			                columns:[
			                [  
			                	{field:'txnSetDate',title:'Clearing Date',sortable:true},
			                    {field:'clientid',title:'Client ID',sortable:true},
			                    {field:'txnType',title:'Transaction Type'}, 
			                    {field:'txnCount',title:'Transaction Count'}, 
			                    {field:'txnPaychAmount',title:'Paychannel Amount'},
			                    {field:'txnCur',title:'Transaction Currency'},
			                    {field:'txnCurAmount',title:'Currency Amount'},
			                    {field:'txnSet',title:'Transaction Settle '},
			                    {field:'txnSetAmount',title:'Settle Amount'},
			                    {field:'txnFee',title:'Transaction Fee'},
			                    {field:'txnIncome',title:'Transaction Income'}
			                ]
			                ],  
			                remoteSort:false,
			                sortName:'txnSetDate',
