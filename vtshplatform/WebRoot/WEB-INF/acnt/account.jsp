...
<body style="font-family:Arial;">         
            	<script> 
            		var trans = [{"_id":"52c664add97e8717f390c9f1","clientid":"000000000000015","fee":{"fee1":"0.01","fee2":"0.01"},"md5":"12345678","unionpay":{"merchantId":"000000000000015","md5":"88888888","acqcode":"28460840","front_url":"http:\/\/211.147.64.194\/front","back_url":"http:\/\/211.147.64.194\/back"}},{"_id":"52c664aed97e8717f390c9f1","clientid":"000000000000015","fee":{"fee1":"0.01","fee2":"0.01"},"md5":"12345678","unionpay":{"merchantId":"000000000000015","md5":"88888888","acqcode":"28460840","front_url":"http:\/\/211.147.64.194\/front","back_url":"http:\/\/211.147.64.194\/back"}},{"_id":"52c6699dd97e8717f390c9f1","clientid":"000000000000015","fee":{"fee1":"0.01","fee2":"0.01"},"md5":"12345678","unionpay":{"merchantId":"000000000000015","md5":"88888888","acqcode":"28460840","front_url":"http:\/\/211.147.64.194\/front","back_url":"http:\/\/211.147.64.194\/back"}},{"_id":"52c664add97e8817f390c9f1","clientid":"000000000000015","fee":{"fee1":"0.01","fee2":"0.01"},"md5":"12345678","unionpay":{"merchantId":"000000000000015","md5":"88888888","acqcode":"28460840","front_url":"http:\/\/211.147.64.194\/front","back_url":"http:\/\/211.147.64.194\/back"}},{"_id":"52c664add97e9617f390c9f1","clientid":"000000000000015","fee":{"fee1":"0.01","fee2":"0.01"},"md5":"12345678","unionpay":{"merchantId":"000000000000015","md5":"88888888","acqcode":"28460840","front_url":"http:\/\/211.147.64.194\/front","back_url":"http:\/\/211.147.64.194\/back"}},{"_id":"52c664add97e8785f390c9f1","clientid":"000000000000015","fee":{"fee1":"0.01","fee2":"0.01"},"md5":"12345678","unionpay":{"merchantId":"000000000000015","md5":"88888888","acqcode":"28460840","front_url":"http:\/\/211.147.64.194\/front","back_url":"http:\/\/211.147.64.194\/back"}}];
            		function getTranValue(){
            			var row = $('#tt3').datagrid('getSelected');
            			alert(row.unionpay.acqcode);
            			//if (row){
					$.messager.confirm('Confirm','Are you sure you want to remove this user?',function(r){
					if (r){
						$.post('remove_user.php',{id:row.md5},function(result){
							if (result.success){
            	...
            	function detailUser(){
					...
					if(row){
						...
						//$('#burl').val(row.unionpay.merchantId);
						//document.getElementById('burl').value=row.unionpay.merchantId;
	...
	<table id="tt3"  style="width:800px;height:300px"></table>
            	<div id="tbar" >
            		...
            		<a class="easyui-linkbutton" plain="true" iconCls="icon-reload" onclick="updateUser();">Update Merchant</a>
...
<!--			    	<td>Merchant Attribute</td><td><input name="" type="text" /></td>-->
			    	...
			    	<tr>
			    	<td>Fee 1</td><td><input name="UP.fee1" type="text" /> </td>
			    	<td>Fee 2</td><td><input name="UP.fee2" type="text" /> </td>
			    	</tr>
...
<!--			   <td>Merchant Attribute</td><td><input name="" type="text" /></td>          -->
			    	...
			    	<tr>
			    	<td>Fee 1</td><td><input name="unionpay.merFee.fee1" type="text" /></td>
			    	</tr>
			    	<tr>
			    	<td>Fee 2</td><td><input name="unionpay.merFee.fee2" type="text" /></td>
			    	</tr>
	...
	<div id="dlg-buttons">
		<a class="easyui-linkbutton"  iconCls="icon-ok"      onclick="showValue();">Save</a>
