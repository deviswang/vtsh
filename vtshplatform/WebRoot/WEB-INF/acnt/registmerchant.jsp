...
<!--			    	<td>Merchant Attribute</td><td><input name="" type="text" /></td>-->
			    	...
			    	<tr>
			    	<td>Fee 1</td><td><input name="fee.fee1" type="text" /></td>
			    	<td>Fee 2</td><td><input name="fee.fee2" type="text" /></td>
			    	</tr>
			 </table>
		</form>
		...
		<form id="modifyAcntForm" method="post" novalidate>
			<table style="height:95%;width:100%;margin:0 auto;border:1px solid #ccc;padding:10px;" >
			    	...
			    	<tr>
			    	<td>Client ID</td><td><input id="clid" name="clientid"  class="easyui-validatebox" data-options="required:true"/></td>
