...
<!--            		<a class="easyui-linkbutton" plain="true" iconCls="icon-add">Add</a>-->
					...
					<form id="tsform" method="post">
						...
						<tr>
<!--						<td><a class="easyui-linkbutton" plain="true" iconCls="icon-edit" onclick="getTransDetails();">Details</a></td>-->
						<td>  <a class="easyui-linkbutton" plain="true" iconCls="icon-search" onclick="searchTranForm();">Search</a></td>
							<td><a class="easyui-linkbutton" plain="true" iconCls="icon-cancel" onclick="resetQueryParams();">Clear</a>
						</td>
						</tr>
					</form>
					</table>
                 ...
                 <script>  
			        ...
			        $(function(){  
			            $('#tt2').datagrid({  
			                ...
			                columns:[
			                [  
			                    {field:'clientid',title:'Merchant ID',sortable:true,formatter:function(val,row){return row.m_request.clientid}},
			                     {field:'merName',title:'Merchant Name',sortable:true,formatter:function(val,row){return row.merchant.merName}},
			                    {field:'orderno',title:'Order Number',sortable:true,formatter:function(val,row){return row.m_request.orderno}}, 
			                    {field:'gw_tran_type',title:'Transaction Type'}, 
			                    {field:'gw_response',title:'Order Result',formatter:function(val,row){
			                   				 var type = row.gw_response;
			                   				 if(type=="00"){return "<span style='color:black'>Success</span>";}
			                   				 else if(type == undefined ){return "<span style='color:green'>Processing</span>";}
			                   				 else return "<span style='color:red'>Failed</span>";
			                    	}},  
			                    {field:'txnamount',title:'Amount',formatter:function(val,row){return row.m_request.txnamount}},  
			                    {field:'txncurrency',title:'Currency',formatter:function(val,row){return row.m_request.txncurrency}},
			                    {field:'txnschema',title:'Payment Channel',formatter:function(val,row){return row.m_request.txnschema}},
			                    {field:'timestamp',title:'Transaction Time',sortable:true,formatter:function(val,row){
	...
	*/	        
			    ...
			    <table style="height:95%;width:100%;margin:0 auto;border:1px solid #ccc;padding:10px;" >
			    	...
			    	<td>G Response</td><td><input name="m_front_response" type="text" /></td>
			    	</tr>
			    	...
			    	<tr>
			    	<td colspan="4" class="subInf">Merchant Response</td>
			    	</tr>
			    	<tr>
			    	<td >Merchant Response</td><td colspan='3'>
			    	<textarea name="back_response_to_merchant" style="height:60px;width:90%;border:0;" readonly></textarea>
<!--			    	<input name="m_front_response" type="text" style="width:90%;"/>-->
			    	</td>
<!--			    	<td>Order Number</td><td><input name="m_request.orderno" type="text" /></td>    -->
			    	</tr>
			    	<tr>
			    	...
			    	<tr>
			    	<td>Merchant Abbr</td><td><input name="back_response_to_g.merAbbr" type="text" /></td>
			    	<td>Merchant Id</td><td><input name="back_response_to_g.merId" type="text" /></td>
			    	</tr>
			    	<tr>
			    	<td>Order Amount</td><td><input name="back_response_to_g.orderAmount" type="text" /></td>
			    	<td>Order Currency</td><td><input name="back_response_to_g.orderCurrency" type="text" /></td>
			    	</tr>
			    	<tr>
			    	...
			    	<tr>
			    	<td colspan="4" class="subInf">Clearing Information</td>
			    	</tr>
			    	<tr>
			    	<td> Settlement Fee1 </td><td><input name="settlefee[0]" type="text" /></td>
			    	<td> Settlement Fee1 </td><td><input name="settlefee[1]" type="text" /></td>
			    	</tr>
			    	<tr>
			    	<td> Settlement Amount1 </td><td><input name="settlefeeAmount[0]" type="text" /></td>
			    	<td> Settlement Amount2 </td><td><input name="settlefeeAmount[1]" type="text" /></td>
			    	</tr>
			    	<tr>
			    	<td colspan="4" height="20"></td>
			    	</tr>
			    	<tr>
			    	<td colspan="4" class="subInf"> CIL Request </td>
			    	</tr>
			    	<tr>
			    	<td> CIL Request </td> <td colspan='3'>
			    	<textarea name="g_request" style="height:150px;width:90%;border:0;" readonly></textarea>
			    	</td>
			    	</tr>
			    </table>
			    </form>
